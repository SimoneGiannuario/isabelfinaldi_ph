...
export const translations: Translations = {
  it: {
    ...
    about: {
      ...
      title2: "l'Obiettivo",
      paragraph1: "Ciao, sono Isabel — una giovane fotografa, che lavora principalmente su Foggia e provincia, con una profonda passione per catturare la bellezza nei momenti quotidiani. Dai ritratti baciati dal sole alle scene urbane cariche di atmosfera, il mio lavoro mescola la luce naturale con l'emozione autentica.",
  ...
  en: {
    ...
    about: {
      ...
      title2: "the Lens",
      paragraph1: "Hi, I'm Isabel — a young Italian photographer, who works mainly in Foggia and province, with a deep passion for capturing the beauty in everyday moments. From sun-kissed portraits to atmospheric street scenes, my work blends natural light with authentic emotion.",
